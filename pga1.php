...
// Verifica se a sessão 'codcli' está definida
...
<body background="img/planodefundo1.webp">
        ...
        <nav class="nav-bar">
            ...
            <div class="nav-list">
                <ul>
                    ...
                    <li class="nav-item"><a href="http://localhost/barbearia/verhorarios.php" class="nav-link">Consultar Horários Disponíveis</a></li>
                </ul>
            </div>
    ...
    <footer>
        ...
        <div id="footer-copyrigth">
            &#169 2023 Todos os direitos reservados para Barber Man Shop
        </div>
    </footer>
